...
class AvailableVersionsTests(utils.TestCase):
    ...
    def test_available_versions_basics(self):
        ...
        for path, text in six.iteritems(examples):
            ...
            self.adapter.register_uri('GET', url, status_code=300, text=text)
    ...
    def test_available_versions_individual(self):
        self.adapter.register_uri('GET', V3_URL, status_code=200,
    ...
    def test_available_keystone_data(self):
        self.adapter.register_uri('GET', BASE_URL, status_code=300,
    ...
    def test_available_cinder_data(self):
        ...
        self.adapter.register_uri('GET', BASE_URL, status_code=300, text=text)
    ...
    def test_available_glance_data(self):
        ...
        self.adapter.register_uri('GET', BASE_URL, status_code=200, text=text)
...
class ClientDiscoveryTests(utils.TestCase):
    ...
    def assertCreatesV2(self, **kwargs):
        self.adapter.register_uri('POST', "%s/tokens" % V2_URL,
    ...
    def test_discover_200_response_fails(self):
        self.adapter.register_uri('GET', BASE_URL,
    ...
    def test_discover_individual_version_v2(self):
        self.adapter.register_uri('GET', V2_URL, status_code=200,
    ...
    def test_discover_forwards_original_ip(self):
        ...
        self.assertThat(self.adapter.last_request.headers['forwarded'],
    ...
    def test_greater_version_than_required(self):
        resp = [{'id': 'v3.6',
                 ...
                 'status': 'stable',
                 'updated': UPDATED}]
        self.adapter.register_uri('GET', BASE_URL, status_code=200,
                                  text=_create_version_list(resp))
    ...
    def test_overriding_stored_kwargs(self):
        ...
        self.adapter.register_uri('POST', "%s/auth/tokens" % V3_URL,
                                  text=V3_AUTH_RESPONSE,
                                  headers={'X-Subject-Token': V3_TOKEN})
    ...
    def test_unknown_client_version(self):
        V4_VERSION = {'id': 'v4.0',
                      ...
                      'status': 'stable',
                      'updated': UPDATED}
        text = _create_version_list([V4_VERSION, V3_VERSION, V2_VERSION])
        self.adapter.register_uri('GET', BASE_URL, status_code=300, text=text)
