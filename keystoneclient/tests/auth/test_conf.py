...
class ConfTests(utils.TestCase):
    ...
    def test_loading_invalid_plugin(self):
        self.conf_fixture.config(auth_plugin='invalid',
                                 auth_section=self.V3TOKEN,
                                 group=self.GROUP)
    ...
    def test_bad_params(self, driver_manager):
        ...
        self.conf_fixture.config(auth_plugin=driver_name, group=self.GROUP)
