...
class ClientTest(utils.TestCase):
    ...
    def test_get(self):
        ...
        resp, body = cl.get("/hi")
        self.assertEqual(self.adapter.last_request.method, 'GET')
        self.assertEqual(self.adapter.last_request.url, self.TEST_URL)
    ...
    def test_post(self):
        ...
        self.assertEqual(self.adapter.last_request.method, 'POST')
        self.assertEqual(self.adapter.last_request.body, six.b('[1, 2, 3]'))
...
class BasicRequestTests(utils.TestCase):
    ...
    def request(self, method='GET', response='Test Response', status_code=200,
        ...
        self.adapter.register_uri(method, url, text=response,
    ...
    def test_basic_params(self):
        ...
        self.assertEqual(self.adapter.last_request.method, method)
