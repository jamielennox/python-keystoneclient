...
class Client(httpclient.HTTPClient):
    ...
    def __init__(self, **kwargs):
        ...
        self.extensions = extensions.ExtensionManager(self.http_adapter)
        ...
        self.users = users.UserManager(self.http_adapter, self.roles)

        self.tenants = tenants.TenantManager(self.http_adapter,
                                             self.roles, self.users)

        # extensions
        self.ec2 = ec2.CredentialsManager(self.http_adapter)
