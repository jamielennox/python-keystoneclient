...
class _KeystoneAdapter(adapter.LegacyJsonAdapter):
    ...
    def user_id(self):
        ...
        if isinstance(self.session.auth, base_identity.BaseIdentityPlugin):
...
class HTTPClient(baseclient.Client, base.BaseAuthPlugin):
    ...
    def __init__(self, username=None, tenant_id=None, tenant_name=None,
        ...
        self.api = _KeystoneAdapter(session,
    ...
    def authenticate(self, username=None, password=None, tenant_name=None,
        ...
        * if force_new_token is true
        ...
        region_name = region_name or self.api.region_name
    ...
    def __getattr__(self, name):
        ...
        try:
            ...
            return getattr(self.api, var_name or name)
    ...
    def __setattr__(self, name, val):
        ...
        try:
            ...
            return setattr(self.api, var_name or name)
